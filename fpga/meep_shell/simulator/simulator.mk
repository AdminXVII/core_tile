...
EXTRA_LDFLAGS += $(THIRD_PARTY_DIR)/softfloat/build/Linux-x86_64-GCC/softfloat.a
EXTRA_LDFLAGS += -Wl,-rpath,$(THIRD_PARTY_DIR)/ramulator -L$(THIRD_PARTY_DIR)/ramulator -lramulator -pthread -g
...
MEEP_VERI_FLAGS = \
	...
	-CFLAGS "-std=c++17 -I$(SPIKE_DIR)/riscv-isa-sim/ -I$(VORTEX_DPI_DIR) -I$(VORTEX_SIM_INCLUDE_DIR) -I$(VORTEX_HEADERS) $(THIRD_PARTY_LIBS) -g" \
...
MEEP_VERI_OPTI_FLAGS = -O2 -g -CFLAGS "-O2 -g"
